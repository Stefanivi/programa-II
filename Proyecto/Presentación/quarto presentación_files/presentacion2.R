<<<<<<< HEAD:Proyecto/Presentación/quarto presentación_files/presentacion2.R
# ── Librerías
library(sf)
library(readxl)
library(dplyr)
...
>>>>>>> c57946e2d26fdd4737ce9fcdfc1e6a159721af92:Proyecto/Presentacion/quarto presentación_files/presentacion2.R
